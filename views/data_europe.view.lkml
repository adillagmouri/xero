# The name of this view in Looker is "Data Europe"
view: data_europe {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `xero-387613.xero_sales.data_europe`
    ;;
  ...
  measure: total_price_12_pallets_2000g {
    type: sum
    sql: ${price_12_pallets_2000g} ;;
  }

  measure: average_price_12_pallets_2000g {
    type: average
    sql: ${price_12_pallets_2000g} ;;
  }
