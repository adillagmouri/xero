# The name of this view in Looker is "Data Usa"
view: data_usa {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `xero-387613.xero_sales.data_usa`
    ;;
  ...
  dimension: price_25_pallets_2000g_35 {
    type: string
    sql: ${TABLE}.Price_25_pallets_2000g_35 ;;
  }
